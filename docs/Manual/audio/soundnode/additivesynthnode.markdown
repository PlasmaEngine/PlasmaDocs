...
- A custom synthesizer using [MIDI ](https://plasmaengine.github.io/PlasmaDocs/Manual/audio/midi/) events sent by a keyboard or other device
...
- [MIDI ](https://plasmaengine.github.io/PlasmaDocs/Manual/audio/soundnode/midi.markdown)
