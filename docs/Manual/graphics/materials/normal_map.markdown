...
NOTE: If the normal map seems like a mix of green and yellow, it's probably because the textures been compressed with `BC5`.  For more on block compression, visit [Block Compression](https://plasmaengine.github.io/PlasmaDocs/Manual/plasmamanual/graphics/adding_assets/block_compression.markdown).
