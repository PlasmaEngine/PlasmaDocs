...
We can test the calls to these [functions](https://plasmaengine.github.io/PlasmaDocs/Manual/Lightning/functions.markdown) to see the interplay of casting:
...
The binary '+' operator 'Positive / Add' is not valid with 'ControllerButtons' and 'Directions'.
 ...
 # Related Materials
 ## Manual
- [casting](https://plasmaengine.github.io/PlasmaDocs/Manual/Lightning/casting.markdown)
