...
* `RootMotion`: If the animation clip should be able to move the [game object](game-objects.md), this can be achieved through [root motion](root-motion.md). This option allows you to select how root motion should be incorporated into the animation clip.
