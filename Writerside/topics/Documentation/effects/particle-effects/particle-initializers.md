...
**ScaleXParam, ScaleYParam, ScaleZParam:** Optional names of [effect parameters](Particle-Effects.md#effect-parameters). This allows to scale the volume in which particles spawn.
...
Optional names of [effect parameters](Particle-Effects.md#effect-parameters). This allows to scale the volume in which particles spawn.
...
Optional name of an [effect parameter](Particle-Effects.md#effect-parameters). This allows to scale the volume in which particles spawn.
