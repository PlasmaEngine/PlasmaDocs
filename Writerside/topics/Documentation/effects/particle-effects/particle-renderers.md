...
**TintColorParam:** An optional [effect parameter](Particle-Effects.md#effect-parameters) name. If set, the parameter is used to tint the final color of the particle.
...
**TintColorParam:** An optional [effect parameter](Particle-Effects.md#effect-parameters) name. If set, the parameter is used to tint the color of the meshes.
...
**TintColorParam:** An optional [effect parameter](Particle-Effects.md#effect-parameters) name. If set, the parameter is used to tint the color of the lights.

**IntensityScaleParam:** An optional [effect parameter](Particle-Effects.md#effect-parameters) name. If set, the parameter is used to scale the intensity of the lights.

**SizeScaleParam:** An optional [effect parameter](Particle-Effects.md#effect-parameters) name. If set, the parameter is used to scale the light influence radius.
