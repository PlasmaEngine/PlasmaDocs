...
**OnCollideEvent:** An optional name of an [event](Particle-Effects.md#events-and-event-reactions) to raise. If set, other effects or prefabs can be spawned at the location of impact.
